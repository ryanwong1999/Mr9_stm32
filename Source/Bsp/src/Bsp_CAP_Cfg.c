...
#define ENCODER_RESOLUTION 1    /*±àÂëÆ÷Ò»È¦µÄÎïÀíÂö³åÊý*/
#define ENCODER_MULTIPLE 4      /*±àÂëÆ÷±¶Æµ£¬Í¨¹ý¶¨Ê±Æ÷µÄ±àÂëÆ÷Ä£Ê½ÉèÖÃ*/
#define MOTOR_REDUCTION_RATIO 1 /*µç»úµÄ¼õËÙ±È*/
/*µç»ú×ªÒ»È¦×ÜµÄÂö³åÊý(¶¨Ê±Æ÷ÄÜ¶Áµ½µÄÂö³åÊý) = ±àÂëÆ÷ÎïÀíÂö³åÊý*±àÂëÆ÷±¶Æµ*µç»ú¼õËÙ±È */
#define TOTAL_RESOLUTION ( ENCODER_RESOLUTION*ENCODER_MULTIPLE*MOTOR_REDUCTION_RATIO ) 

#define TIM_PERIOD 65535

#define ENCODER_TIM_PSC  0          /*¼ÆÊýÆ÷·ÖÆµ*/
#define ENCODER_TIM_PERIOD  65535   /*¼ÆÊýÆ÷×î´óÖµ*/
#define CNT_INIT 1000                  /*¼ÆÊýÆ÷³õÖµ*/

/*=============================================================================
*  º¯ÊýÃû £ºTIM_ICP_Cfg_Init
*  ×÷   Õß£ºhrx
*  ´´½¨Ê±¼ä£º2022Äê3ÔÂ5ÈÕ 
*  ÐÞ¸ÄÊ±¼ä£º
*  Êä   Èë£ºiArr  -> ×°ÔØÖµ
...
{	
	...
	TIM_TimeBaseStructure.TIM_ClockDivision=TIM_CKD_DIV1;		        //¶ÔÍâ²¿Ê±ÖÓ½øÐÐ²ÉÑùµÄÊ±ÖÓ·ÖÆµ,ÕâÀïÃ»ÓÐÓÃµ½ */
	TIM_TimeBaseStructure.TIM_CounterMode=TIM_CounterMode_Up;	      //¼ÆÊý·½Ê½
	...
	ICP_ICInitStructure.TIM_ICPolarity = TIM_ICPolarity_Rising;	  	//ÉÏÉýÑØ²¶»ñ
	...
	TIM_ITConfig(CAP_TIM, TIM_IT_CC1, ENABLE);											//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
	TIM_ITConfig(CAP_TIM, TIM_IT_CC2, ENABLE);											//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
	TIM_ITConfig(CAP_TIM, TIM_IT_CC3, ENABLE);											//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
	TIM_ITConfig(CAP_TIM, TIM_IT_CC4, ENABLE);											//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
...
//	TIM_ICInit(TIM8, &ICP_ICInitStructure);	 
//	
//	TIM_ITConfig(TIM8, TIM_IT_CC1, ENABLE);//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
//	TIM_ITConfig(TIM8, TIM_IT_CC2, ENABLE);//ÔÊÐí¸üÐÂÖÐ¶Ï ,ÔÊÐíCC1IE²¶»ñÖÐ¶Ï	
//	
//	//TIM_Cmd(CAP_TIM, ENABLE ); 	                           //Ê¹ÄÜ¶¨Ê±Æ÷5
//	TIM_Cmd(CAP_TIM, DISABLE ); 	                           //½ûÖ¹¶¨Ê±Æ÷5
//	//NVIC ÅäÖÃ, Í³Ò»·ÅÖÃÓÚmain.c Í³Ò»´¦Àí
...
void TIM8_Configuration(void)
{
    ...
    /* ±àÂëÆ÷Ä£Ê½ÅäÖÃ£ºÍ¬Ê±²¶»ñÍ¨µÀ1ÓëÍ¨µÀ2(¼´4±¶Æµ)£¬¼«ÐÔ¾ùÎªRising */
